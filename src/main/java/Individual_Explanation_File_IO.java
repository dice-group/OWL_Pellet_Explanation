...
public class Individual_Explanation_File_IO {

    public void run(String ns, String localOntologyPath, String queryStr, String individualName, String outputFilePath) throws OWLOntologyCreationException, OWLException, IOException {
    ...
    public static void main(String[] args) throws OWLOntologyCreationException, OWLException, IOException {
        ...
        System.out.print("Enter the individual name (e.g., F8M136): ");
        String individualName = scanner.nextLine();

        // Take the output file path input from user
        System.out.print("Enter the output file path where the explanation should be saved (e.g., E:/Workspace_Dice/Output/explanation.txt): ");
        String outputFilePath = scanner.nextLine();

        // Run the explanation with user inputs
        Individual_Explanation_File_IO app = new Individual_Explanation_File_IO();
        app.run(ns, localOntologyPath, queryStr, individualName, outputFilePath);
